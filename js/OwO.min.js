  ...
  var OwO = function () {
    ...
    _createClass(OwO, [{
      ...
      value: function init(option) {
        ...
        var html = '\n            <div class="OwO-logo padder-v-sm"><span class="smile-icons"></span><span class="OwOlogotext">' + option.logo + '</span></div>\n            <div class="OwO-body" style="width: ' + option.width + '"><div class="OwO-title"><span>OwO</span></div>';
        ...
        for (var i = 0; i < this.packages.length; i++) {
          ...
          for (var _i = 0; _i < opackage.length; _i++) {
            if (this.odata[this.packages[i]].type === 'image') {
              html += '\n                    <li class="OwO-item" title="' + opackage[_i].text + '" data-input="' + this.odata[this.packages[i]].name + ":" + opackage[_i].icon + '">' + '<img noGallery noAlt data-original="' + STY.ASSET_URL + 'OwO/img/' + this.odata[this.packages[i]].name + '/' + opackage[_i].icon + '.png" src="" icon="' + opackage[_i].text + '"></li>';
            } else {
